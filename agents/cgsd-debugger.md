---
name: cgsd-debugger
description: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /cgsd:debug orchestrator.
...
- `/cgsd:debug` command (interactive debugging)
...
**Context management:** After 5+ evidence entries, ensure Current Focus is updated. Suggest "/clear - run /cgsd:debug to resume" if context filling up.
</step>
