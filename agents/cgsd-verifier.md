...
Structure gaps in YAML frontmatter for `/cgsd:plan-phase --gaps`:
...
_Verifier: Claude (cgsd-verifier)_
```
...
Structured gaps in VERIFICATION.md frontmatter for `/cgsd:plan-phase --gaps`.
