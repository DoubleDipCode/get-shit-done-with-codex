...
- This section feeds directly into /cgsd:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /cgsd:plan-phase --gaps with root causes
...
**Creation:** When /cgsd:verify-work starts new session
