...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /cgsd:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/cgsd:discuss-phase [current-phase])
2. Create phase plan (/cgsd:plan-phase [current-phase])
