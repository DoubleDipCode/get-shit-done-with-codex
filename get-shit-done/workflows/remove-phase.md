...
- Example: `/cgsd:remove-phase 17` → phase = 17
- Example: `/cgsd:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /cgsd:remove-phase <phase-number>
Example: /cgsd:remove-phase 17
```
...
To abandon current work, use /cgsd:pause-work instead.
```
...
Would you like to:
- `/cgsd:progress` — see updated roadmap status
