<purpose>
Research how to implement a phase. Spawns cgsd-phase-researcher with phase context.

Standalone research command. For most workflows, use `/cgsd:plan-phase` which integrates research automatically.
</purpose>
...
Write to: .planning/phases/${PHASE}-{slug}/${PHASE}-RESEARCH.md
  ...
  subagent_type="cgsd-phase-researcher",
