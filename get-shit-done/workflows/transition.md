...
Exit skill and invoke SlashCommand("/cgsd:plan-phase [X+1]")
...
**Also available:**
- `/cgsd:discuss-phase [X+1]` — gather context first
- `/cgsd:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/cgsd:complete-milestone {version}")
